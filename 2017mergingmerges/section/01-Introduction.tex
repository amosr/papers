...
\amos{The split/join distinction is actually more about pushes vs pulls, as \emph{some} joins can be expressed with synchronous dataflow eg non-deterministic merge}
