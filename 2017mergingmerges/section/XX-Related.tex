...
\item Lucy-n: extension of LUSTRE with periodic clocks to ensure static scheduling \cite{mandel2010lucy}, \cite{benveniste2003synchronous}
...
\item Prelude: extension of LUSTRE, seems very similar to Lucy-n \cite{pagetti2011multi}
\item Ptolemy (II)
\end{itemize}
