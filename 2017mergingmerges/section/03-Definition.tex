...
\begin{code}
  ...
  alternates sIn1 sIn2 sIn3
   = let  sA1     = alt2 sIn1 sIn2
          sA2     = alt2 sIn2 sIn3
     in   zip sA1 sA2
\end{code}

Given the inputs @sIn1@ = $[a1, a2]$, @sIn2@ = $[b1, b2]$ and @sIn3@ = $[c1, c2]$ the \\ output will be $[ (a1, b1), (a2, b2), (b1, c1), (b2, c2) ]$

\TODO{Explain why this needs a specific evaluation order, and some do not work. Needs to fit on this page. Lead into the fusion order talk later.}
