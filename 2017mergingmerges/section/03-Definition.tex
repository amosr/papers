...
%%% AR: "a different version" - bit vague, maybe something like "a different version with only the statically known information"
...
%%% AR: I think it's clearer to say ``updated process'' than ``new process'' because it implies that it is, in essence, the same process
...
%%% AR: not sure what you mean about producing process discarding it
