...
\addplot coordinates {(360,Conduit) (310,Pipes) (235,Streaming) (160,Ours) (0,end) };
\end{axis}
\end{tikzpicture}
...
\begin{tikzpicture}
\begin{axis}[
  symbolic y coords={Streaming, Conduit, Pipes, Ours, end},
	xlabel=Runtime (ms),
  xmin=0, xmax=1570,
	enlargelimits=0.01,
	xbar interval=0.7,
...
\addplot coordinates {(1570,Streaming) (980,Conduit) (940,Pipes) (590,Ours) (0,end) };
\end{axis}
\end{tikzpicture}
