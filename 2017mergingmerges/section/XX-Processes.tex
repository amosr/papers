...
% BL: Just start into the description.
%     Readers will work out what's coming by flipping through the paper themselves.
% This section describes processes in detail. We start with an informal explanation of processes before formally defining the syntax and dynamic semantics.
