...
The reduction of the clustering problem to integer linear programming was previously described by \cite{megiddo1998weighted}, though they do not consider filtering operations.
