...
We used GLPK as an external solver, which is not particularly fast, but has Haskell bindings.
...
One randomly generated example with twenty-five combinators took over twenty minutes in GLPK, while the commercial solver CPLEX was able to solve the same example in six seconds, and another open source solver CBC took ninety seconds.
