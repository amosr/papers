...
We have run three benchmarks to constrast our clustering algorithm, Megiddo~\cite{megiddo1998optimal}'s clustering, and the clustering produced by stream fusion\cite{coutts2007streamfusion}.
...
Each program was ran with the same input five times, and the minimum runtime was used.
