...
Finally, \TODO{filter is only one representative size changing operator. mention @unfoldr@, @dups@ etc. Can add these by making the size of the result existential} 
