...
\ruleIC{o = @fold@~f~n}{}{\tau_o = k_n, }

\vspace{1em}

\ruleIC{o = @map@_n~f~ns}{\forall k_o.\ \bigwedge_{n \in ns}\{k_o = k_n\} \wedge}{\tau_o = k_o, }

\vspace{1em}

\ruleIC{o = @filter@~f~n}{\exists k_o \le k_n.\ }{\tau_o = k_n, }
...
\ruleIC{o = @gather@~i~d}{\forall k_o.\ k_o = k_i \wedge}{\tau_o = k_i, }

\vspace{1em}

\ruleIC{o = @cross@~a~b}{\forall k_o.\ k_o = k_a \times k_b \wedge C}{\tau_o = k_a \times k_b, }

\vspace{1em}

\ruleIC{outs = @external@~ins}{\exists_{o \in outs} k_o.\ }{\tau_{outs} = @external@, }
