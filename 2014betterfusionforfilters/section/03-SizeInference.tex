...
\end{array}
$$
Rule~(SFun) also characterises the functions we accept: A function is \emph{valid} if and only if $\exists \sigma.\ \SizeF{\program}{\sigma}$. 
