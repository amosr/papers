...
Syntax-based greedy approaches such as Rompf~\cite{rompf2013optimizing} may find optimal clusterings, but rely on the order of bindings.
In these cases, reordering bindings can produce a different clustering, whereas graph-based approaches are immune to this.
\amos{Horizon effect?}
