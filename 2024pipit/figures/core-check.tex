...
\begin{figure}
  ...
  \ruleAx{\semcheck{\sigma}{\PStatus}{\xfby{v}{e'}}}{$\mbox{ChkFby}_1$}
    ...
    \inferrule{
      ...
      \\\\
      (\PStatus = \PSValid \implies \bigstepalways{\Sigma}{\erely} \implies \bigstepalways{\Sigma}{\eguar[x := \eimpl]})
      \\\\
      \semcheck{\Sigma}{\PStatus}{\erely}
      \\\\
      (\bigstepalways{\Sigma}{\erely} \implies \semcheck{\Sigma}{\PStatus}{\eimpl} ~\wedge~ \semcheck{\Sigma}{\PStatus}{\eguar[x := \eimpl]})
    }{
      \semcheck{\Sigma}{\PStatus}{\xcontractP{\PStatus'}{\erely}{\eimpl}{\rawbind{x}{\eguar[x]}}}
    }(\textsc{ChkContract})
