...
\TODO{include example contract to highlight the streaming / reactive aspects of rely-guarantee contracts}
...
\TODO{include example of checked semantics for both valid and invalid programs}
