...
\TODO{describe encoding issues and minor differences between properties in both systems}
\TODO{include comparison of required proof size vs runnable code}
\TODO{clarify wall-clock vs user-time in Figure 11}
\TODO{expand Figure 11 to show Kind2 timeout on larger arrays (eg up to 128)}
