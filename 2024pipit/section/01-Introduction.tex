...
\begin{itemize}
  ...
  \item we describe a \emph{checked semantics} for Pipit, which is parameterised by the property status; by checking deferred properties, programs can be \emph{blessed}, and their property lifted to valid status (\TODO{ref});
  \item we describe the translation to transition system (\TODO{ref});
  ...
  \item we evaluate Pipit by implementing and partially-verifying a time-triggered CAN bus driver (\TODO{ref}).
\end{itemize}
