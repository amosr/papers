...
\TODO{include example of translated executable transition system}
...
\TODO{describe the structure of the generated C code, and highlight how it can be executed in a real-time (streaming) environment}