...
\input{section/20-Motivation.tex}
\input{section/30-Core.tex}
\input{section/35-Primitive-Tables.tex}
\input{section/40-Transition.tex}
\input{section/50-Extraction.tex}
\input{section/60-Evaluation.tex}
\input{section/70-Related.tex}
\input{section/80-Conclusion.tex}
