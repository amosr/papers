...
\begin{axis}[
	...
	ybar interval=0.7,
  symbolic x coords={R, grep, wc, Icicle-372, wc -l, Icicle-1, disk, end}
]
\addplot coordinates {(R,6.6) (grep,74) (wc,251) (Icicle-372,543) (wc -l,775) (Icicle-1,1060) (disk,1800) (end,0) };
...
The table in figure~\ref{fig:bench:table} shows the throughput in megabytes per second.
