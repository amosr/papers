...
\item
We present production benchmarks of Icicle compiled code which compare favourably to standard unix utilities, and outperform an existing R feature generation system by several orders of magnitude\sref{s:Benchmarks}.
\end{itemize}
