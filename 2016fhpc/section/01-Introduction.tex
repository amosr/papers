...
\begin{itemize}
\item
we show a typesystem that guarantees any two queries on the same table can be fused together, as well as allowing queries to be resumed as new data is received\sref{s:IcicleSource};
