...
\ben{The rules here use lambda abstraction, but the expression language in Figure 1 does not include a lambda abstraction construct}.

\ben{In EvWhere, the @where@ keyword appears in the grammar for $Clock$, not the grammar for $Exp$. The judgment being defined is for $Exp$.}

\ben{Also in EvFold, you're using the $\Downarrow$ judgment on $Clock$ expressions.}
