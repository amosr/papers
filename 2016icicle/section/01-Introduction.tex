...
For feature generation for machine learning, our queries have some quite specific restrictions. \ben{The following describes properties that that queries and data have intrinsically, not \emph{restrictions} placed on them}.
